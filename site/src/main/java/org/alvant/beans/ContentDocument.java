...
@HippoEssentialsGenerated(internalName = "alvanthippoproject:contentdocument")
@Node(jcrType = "alvanthippoproject:contentdocument")
public class ContentDocument extends BaseDocument {
    ...
    public String getIntroduction() {
        return getProperty("alvanthippoproject:introduction");
    }
    ...
    @HippoEssentialsGenerated(internalName = "alvanthippoproject:publicationdate")
    public Calendar getPublicationDate() {
        return getProperty("alvanthippoproject:publicationdate");
    }
}
